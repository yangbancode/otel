...
| `[~]` | 17 | Delta temporality | reader configured `:delta` | Mimir: drops (LGTM 0.26.0's OTLP receiver has delta-to-cumulative as opt-in, off by default); SDK encoding verified by unit tests |
