...
- [x] Output temporality function SHOULD be obtained from the exporter; if not configured, Cumulative temporality SHOULD be used — [L1306](../references/opentelemetry-specification/specification/metrics/sdk.md#L1306)
...
- [x] MetricReader MUST ensure data points from OTel instruments are output in the configured aggregation temporality — [L1321](../references/opentelemetry-specification/specification/metrics/sdk.md#L1321)
- [x] For synchronous instruments with Cumulative temporality, Collect MUST receive data points exposed in previous collections — [L1339](../references/opentelemetry-specification/specification/metrics/sdk.md#L1339)
- [x] For synchronous instruments with Delta temporality, Collect MUST only receive data points with measurements recorded since the previous collection — [L1342](../references/opentelemetry-specification/specification/metrics/sdk.md#L1342)
...
- [x] For Cumulative temporality, successive data points MUST repeat the same starting timestamps — [L1354](../references/opentelemetry-specification/specification/metrics/sdk.md#L1354)
- [x] For Delta temporality, successive data points MUST advance the starting timestamp — [L1357](../references/opentelemetry-specification/specification/metrics/sdk.md#L1357)
...
- [x] Collect on one MetricReader SHOULD NOT introduce side-effects to other MetricReader instances — [L1367](../references/opentelemetry-specification/specification/metrics/sdk.md#L1367)
...
### LoggerProvider
- [x] API SHOULD provide a way to set/register and access a global default LoggerProvider — [L59](../references/opentelemetry-specification/specification/logs/api.md#L59)
- [x] LoggerProvider MUST provide Get a Logger function — [L64](../references/opentelemetry-specification/specification/logs/api.md#L64)

### Get a Logger
- [x] API MUST accept `name` parameter (instrumentation scope) — [L70](../references/opentelemetry-specification/specification/logs/api.md#L70)
- [x] API MUST accept optional `version` parameter — [L85](../references/opentelemetry-specification/specification/logs/api.md#L85)
- [x] API MUST accept optional `schema_url` parameter — [L88](../references/opentelemetry-specification/specification/logs/api.md#L88)
- [x] API MUST accept optional `attributes` parameter, structured for variable number including none — [L92](../references/opentelemetry-specification/specification/logs/api.md#L92)

### Logger
- [x] Logger MUST provide function to Emit a LogRecord — [L103](../references/opentelemetry-specification/specification/logs/api.md#L103)
- [x] Logger SHOULD provide function to report if Enabled — [L107](../references/opentelemetry-specification/specification/logs/api.md#L107)

### Emit a LogRecord
- [x] API MUST accept Timestamp (optional) — [L117](../references/opentelemetry-specification/specification/logs/api.md#L117)
- [x] API MUST accept Observed Timestamp (optional) — [L118](../references/opentelemetry-specification/specification/logs/api.md#L118)
- [x] API MUST accept Context; if implicit supported SHOULD be optional, MUST use current if unspecified — [L119](../references/opentelemetry-specification/specification/logs/api.md#L119)
- [x] When only explicit Context supported, parameter SHOULD be required — [L122](../references/opentelemetry-specification/specification/logs/api.md#L122)
- [x] API MUST accept Severity Number (optional) — [L123](../references/opentelemetry-specification/specification/logs/api.md#L123)
- [x] API MUST accept Severity Text (optional) — [L124](../references/opentelemetry-specification/specification/logs/api.md#L124)
- [x] API MUST accept Body (optional) — [L125](../references/opentelemetry-specification/specification/logs/api.md#L125)
- [x] API MUST accept Attributes (optional) — [L126](../references/opentelemetry-specification/specification/logs/api.md#L126)
- [x] API MUST accept Event Name (optional) — [L127](../references/opentelemetry-specification/specification/logs/api.md#L127)

### Enabled
- [x] Logger SHOULD provide Enabled API — [L135](../references/opentelemetry-specification/specification/logs/api.md#L135)
- [x] Enabled API SHOULD accept Context parameter (optional if implicit supported, MUST use current if unspecified) — [L140](../references/opentelemetry-specification/specification/logs/api.md#L140)
- [x] When only explicit Context, accepting Context parameter is REQUIRED — [L143](../references/opentelemetry-specification/specification/logs/api.md#L143)
- [x] Enabled API SHOULD accept Severity Number (optional) — [L144](../references/opentelemetry-specification/specification/logs/api.md#L144)
- [x] Enabled API SHOULD accept Event Name (optional) — [L145](../references/opentelemetry-specification/specification/logs/api.md#L145)
- [x] Enabled MUST return a language idiomatic boolean type — [L147](../references/opentelemetry-specification/specification/logs/api.md#L147)
- [x] API SHOULD be documented that authors need to call each time they emit a LogRecord — [L152](../references/opentelemetry-specification/specification/logs/api.md#L152)

### Optional and Required Parameters
- [x] For each optional parameter, API MUST be structured to accept it but MUST NOT obligate user to provide it — [L161](../references/opentelemetry-specification/specification/logs/api.md#L161)
- [x] For each required parameter, API MUST be structured to obligate user to provide it — [L164](../references/opentelemetry-specification/specification/logs/api.md#L164)
...
### LoggerProvider
- [x] All language implementations MUST provide an SDK — [L55](../references/opentelemetry-specification/specification/logs/sdk.md#L55)
- [x] LoggerProvider MUST provide a way to allow a Resource to be specified — [L59](../references/opentelemetry-specification/specification/logs/sdk.md#L59)
- [x] If Resource is specified, it SHOULD be associated with all LogRecords produced — [L60](../references/opentelemetry-specification/specification/logs/sdk.md#L60)

### LoggerProvider Creation
- [x] SDK SHOULD allow creation of multiple independent LoggerProviders — [L65](../references/opentelemetry-specification/specification/logs/sdk.md#L65)

### Logger Creation
- [x] It SHOULD only be possible to create Logger instances through a LoggerProvider — [L69](../references/opentelemetry-specification/specification/logs/sdk.md#L69)
- [x] LoggerProvider MUST implement the Get a Logger API — [L72](../references/opentelemetry-specification/specification/logs/sdk.md#L72)
...
- [x] A message reporting invalid value SHOULD be logged — [L81](../references/opentelemetry-specification/specification/logs/sdk.md#L81)
...
- [x] If configuration is updated, it MUST also apply to all already returned Loggers — [L97](../references/opentelemetry-specification/specification/logs/sdk.md#L97)

### Shutdown
- [x] Shutdown MUST be called only once for each LoggerProvider instance — [L140](../references/opentelemetry-specification/specification/logs/sdk.md#L140)
- [x] After Shutdown, subsequent attempts to get Logger are not allowed; SDKs SHOULD return no-op Logger — [L141](../references/opentelemetry-specification/specification/logs/sdk.md#L141)
- [x] Shutdown SHOULD provide a way to let caller know success/failure/timeout — [L144](../references/opentelemetry-specification/specification/logs/sdk.md#L144)
- [x] Shutdown SHOULD complete or abort within some timeout — [L147](../references/opentelemetry-specification/specification/logs/sdk.md#L147)
- [x] Shutdown MUST be implemented by invoking Shutdown on all registered LogRecordProcessors — [L152](../references/opentelemetry-specification/specification/logs/sdk.md#L152)

### ForceFlush
- [x] ForceFlush SHOULD provide a way to let caller know success/failure/timeout — [L163](../references/opentelemetry-specification/specification/logs/sdk.md#L163)
- [x] ForceFlush SHOULD return ERROR status on error, NO ERROR otherwise — [L163](../references/opentelemetry-specification/specification/logs/sdk.md#L163)
- [x] ForceFlush SHOULD complete or abort within some timeout — [L167](../references/opentelemetry-specification/specification/logs/sdk.md#L167)
- [x] ForceFlush MUST invoke ForceFlush on all registered LogRecordProcessors — [L172](../references/opentelemetry-specification/specification/logs/sdk.md#L172)

### Emit a LogRecord (SDK)
- [x] If Observed Timestamp is unspecified, implementation SHOULD set it equal to current time — [L226](../references/opentelemetry-specification/specification/logs/sdk.md#L226)
- [x] If Exception is provided, SDK MUST by default set attributes from exception with semantic conventions — [L228](../references/opentelemetry-specification/specification/logs/sdk.md#L228)
- [x] User-provided attributes MUST take precedence and MUST NOT be overwritten by exception-derived attributes — [L231](../references/opentelemetry-specification/specification/logs/sdk.md#L231)
...
- [x] Documentation SHOULD warn users that output format is not standardized — [L13](../references/opentelemetry-specification/specification/logs/sdk_exporters/stdout.md#L13)
- [x] By default stdout exporter SHOULD be paired with a simple processor — [L33](../references/opentelemetry-specification/specification/logs/sdk_exporters/stdout.md#L33)
