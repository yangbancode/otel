...
`get_tracer/1,2,3` accepts name (required), version (optional), schema_url (optional). Returns a Tracer tuple. Invalid name (nil or empty) returns a working Tracer with empty name and logs a warning.
...
- [Trace API](../compliance/trace-api.md)
  ...
  * Get a Tracer — L115, L117, L126, L128, L129, L146
  * Tracer — L193, L197
