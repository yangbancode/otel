defmodule Otel.Configuration.Schema do
  @moduledoc """
  ...
  **No caching by design.** `Otel.Configuration.load!/0` is called
  ...
  `Otel.Configuration.Composer`'s responsibility (separate PR), since
