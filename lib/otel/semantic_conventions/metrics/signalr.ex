defmodule Otel.SemanticConventions.Metrics.SignalR do
  ...
  Unit: `{connection}`
      ...
      iex> Otel.SemanticConventions.Metrics.SignalR.signalr_server_active_connections()
  ...
  Unit: `s`
      ...
      iex> Otel.SemanticConventions.Metrics.SignalR.signalr_server_connection_duration()
