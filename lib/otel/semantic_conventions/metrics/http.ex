defmodule Otel.SemanticConventions.Metrics.HTTP do
  ...
  Unit: `s`
      ...
      iex> Otel.SemanticConventions.Metrics.HTTP.http_client_request_duration()
  ...
  Unit: `s`
      ...
      iex> Otel.SemanticConventions.Metrics.HTTP.http_server_request_duration()
