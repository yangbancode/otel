defmodule Otel.SemanticConventions.Metrics.DotNet do
  ...
  Unit: `{assembly}`
      ...
      iex> Otel.SemanticConventions.Metrics.DotNet.dotnet_assembly_count()
  ...
  Unit: `{exception}`
      ...
      iex> Otel.SemanticConventions.Metrics.DotNet.dotnet_exceptions()
      "dotnet.exceptions"
  """
  ...
  Unit: `{collection}`
      ...
      iex> Otel.SemanticConventions.Metrics.DotNet.dotnet_gc_collections()
  ...
  Unit: `By`
      ...
      iex> Otel.SemanticConventions.Metrics.DotNet.dotnet_gc_heap_total_allocated()
  ...
  Unit: `By`
      ...
      iex> Otel.SemanticConventions.Metrics.DotNet.dotnet_gc_last_collection_heap_fragmentation_size()
  ...
  Unit: `By`
      ...
      iex> Otel.SemanticConventions.Metrics.DotNet.dotnet_gc_last_collection_heap_size()
  ...
  Unit: `By`
      ...
      iex> Otel.SemanticConventions.Metrics.DotNet.dotnet_gc_last_collection_memory_committed_size()
  ...
  Unit: `s`
      ...
      iex> Otel.SemanticConventions.Metrics.DotNet.dotnet_gc_pause_time()
  ...
  Unit: `s`
      ...
      iex> Otel.SemanticConventions.Metrics.DotNet.dotnet_jit_compilation_time()
  ...
  Unit: `By`
      ...
      iex> Otel.SemanticConventions.Metrics.DotNet.dotnet_jit_compiled_il_size()
  ...
  Unit: `{method}`
      ...
      iex> Otel.SemanticConventions.Metrics.DotNet.dotnet_jit_compiled_methods()
  ...
  Unit: `{contention}`
      ...
      iex> Otel.SemanticConventions.Metrics.DotNet.dotnet_monitor_lock_contentions()
  ...
  Unit: `{cpu}`
      ...
      iex> Otel.SemanticConventions.Metrics.DotNet.dotnet_process_cpu_count()
  ...
  Unit: `s`
      ...
      iex> Otel.SemanticConventions.Metrics.DotNet.dotnet_process_cpu_time()
  ...
  Unit: `By`
      ...
      iex> Otel.SemanticConventions.Metrics.DotNet.dotnet_process_memory_working_set()
  ...
  Unit: `{work_item}`
      ...
      iex> Otel.SemanticConventions.Metrics.DotNet.dotnet_thread_pool_queue_length()
  ...
  Unit: `{thread}`
      ...
      iex> Otel.SemanticConventions.Metrics.DotNet.dotnet_thread_pool_thread_count()
  ...
  Unit: `{work_item}`
      ...
      iex> Otel.SemanticConventions.Metrics.DotNet.dotnet_thread_pool_work_item_count()
  ...
  Unit: `{timer}`
      ...
      iex> Otel.SemanticConventions.Metrics.DotNet.dotnet_timer_count()
      "dotnet.timer.count"
  """
