defmodule Otel.SemanticConventions.Attributes.DotNet do
  ...
  Name of the garbage collector managed heap generation.
      ...
      iex> Otel.SemanticConventions.Attributes.DotNet.dotnet_gc_heap_generation()
  ...
  Enum values for `dotnet_gc_heap_generation`.
      ...
      iex> Otel.SemanticConventions.Attributes.DotNet.dotnet_gc_heap_generation_values()[:gen0]
      "gen0"
  """
