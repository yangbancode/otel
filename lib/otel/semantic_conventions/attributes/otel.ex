defmodule Otel.SemanticConventions.Attributes.Otel do
  ...
  Name of the code, either "OK" or "ERROR". **MUST** NOT be set if the status code is UNSET.
      ...
      iex> Otel.SemanticConventions.Attributes.Otel.otel_status_code()
      "otel.status_code"
  """
  ...
  Enum values for `otel_status_code`.
      ...
      iex> Otel.SemanticConventions.Attributes.Otel.otel_status_code_values()[:ok]
      "OK"
  """
  ...
  Description of the Status if it has a value, otherwise not set.
      ...
      iex> Otel.SemanticConventions.Attributes.Otel.otel_status_description()
  ...
  The name of the instrumentation scope - (`InstrumentationScope.Name` in OTLP).
      ...
      iex> Otel.SemanticConventions.Attributes.Otel.otel_scope_name()
      "otel.scope.name"
  """
  ...
  The version of the instrumentation scope - (`InstrumentationScope.Version` in OTLP).
      ...
      iex> Otel.SemanticConventions.Attributes.Otel.otel_scope_version()
      "otel.scope.version"
  """
