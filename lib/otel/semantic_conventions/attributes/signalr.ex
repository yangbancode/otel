defmodule Otel.SemanticConventions.Attributes.SignalR do
  ...
  SignalR HTTP connection closure status.
      ...
      iex> Otel.SemanticConventions.Attributes.SignalR.signalr_connection_status()
  ...
  Enum values for `signalr_connection_status`.
      ...
      iex> Otel.SemanticConventions.Attributes.SignalR.signalr_connection_status_values()[:normal_closure]
      "normal_closure"
  """
  ...
  [SignalR transport type](https://github.com/dotnet/aspnetcore/blob/main/src/SignalR/docs/specs/TransportProtocols.md)
      ...
      iex> Otel.SemanticConventions.Attributes.SignalR.signalr_transport()
      "signalr.transport"
  """
  ...
  Enum values for `signalr_transport`.
      ...
      iex> Otel.SemanticConventions.Attributes.SignalR.signalr_transport_values()[:server_sent_events]
      "server_sent_events"
  """
