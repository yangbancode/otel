defmodule Otel.SemanticConventions.Attributes.DB do
  ...
  The name of a collection (table, container) within the database.
      ...
      iex> Otel.SemanticConventions.Attributes.DB.db_collection_name()
      "db.collection.name"
  """
  ...
  The name of the database, fully qualified within the server address and port.
      ...
      iex> Otel.SemanticConventions.Attributes.DB.db_namespace()
      "db.namespace"
  """
  ...
  The number of queries included in a batch operation.
      ...
      iex> Otel.SemanticConventions.Attributes.DB.db_operation_batch_size()
  ...
  The name of the operation or command being executed.
      ...
      iex> Otel.SemanticConventions.Attributes.DB.db_operation_name()
      "db.operation.name"
  """
  ...
  Low cardinality summary of a database query.
      ...
      iex> Otel.SemanticConventions.Attributes.DB.db_query_summary()
      "db.query.summary"
  """
  ...
  The database query being executed.
      ...
      iex> Otel.SemanticConventions.Attributes.DB.db_query_text()
      "db.query.text"
  """
  ...
  Database response status code.
      ...
      iex> Otel.SemanticConventions.Attributes.DB.db_response_status_code()
  ...
  The name of a stored procedure within the database.
      ...
      iex> Otel.SemanticConventions.Attributes.DB.db_stored_procedure_name()
  ...
  The database management system (DBMS) product as identified by the client instrumentation.
      ...
      iex> Otel.SemanticConventions.Attributes.DB.db_system_name()
      "db.system.name"
  """
  ...
  Enum values for `db_system_name`.
      ...
      iex> Otel.SemanticConventions.Attributes.DB.db_system_name_values()[:mariadb]
      "mariadb"
  """
