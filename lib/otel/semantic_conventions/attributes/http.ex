defmodule Otel.SemanticConventions.Attributes.HTTP do
  ...
  HTTP request headers, `<key>` being the normalized HTTP Header name (lowercase), the value being the header values.
      ...
      iex> Otel.SemanticConventions.Attributes.HTTP.http_request_header()
      "http.request.header"
  """
  ...
  HTTP request method.
      ...
      iex> Otel.SemanticConventions.Attributes.HTTP.http_request_method()
      "http.request.method"
  """
  ...
  Enum values for `http_request_method`.
      ...
      iex> Otel.SemanticConventions.Attributes.HTTP.http_request_method_values()[:connect]
      "CONNECT"
  """
  ...
  Original HTTP method sent by the client in the request line.
      ...
      iex> Otel.SemanticConventions.Attributes.HTTP.http_request_method_original()
  ...
  The ordinal number of request resending attempt (for any reason, including redirects).
      ...
      iex> Otel.SemanticConventions.Attributes.HTTP.http_request_resend_count()
  ...
  HTTP response headers, `<key>` being the normalized HTTP Header name (lowercase), the value being the header values.
      ...
      iex> Otel.SemanticConventions.Attributes.HTTP.http_response_header()
  ...
  [HTTP response status code](https://tools.ietf.org/html/rfc7231#section-6).
      ...
      iex> Otel.SemanticConventions.Attributes.HTTP.http_response_status_code()
  ...
  The matched route template for the request. This **MUST** be low-cardinality and include all static path segments, with dynamic path segments represented with placeholders.
      ...
      iex> Otel.SemanticConventions.Attributes.HTTP.http_route()
      "http.route"
  """
