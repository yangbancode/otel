defmodule Otel.SemanticConventions.Attributes.Network do
  ...
  Local address of the network connection - IP address or Unix domain socket name.
      ...
      iex> Otel.SemanticConventions.Attributes.Network.network_local_address()
  ...
  Local port number of the network connection.
      ...
      iex> Otel.SemanticConventions.Attributes.Network.network_local_port()
      "network.local.port"
  """
  ...
  Peer address of the network connection - IP address or Unix domain socket name.
      ...
      iex> Otel.SemanticConventions.Attributes.Network.network_peer_address()
  ...
  Peer port number of the network connection.
      ...
      iex> Otel.SemanticConventions.Attributes.Network.network_peer_port()
      "network.peer.port"
  """
  ...
  [OSI application layer](https://wikipedia.org/wiki/Application_layer) or non-OSI equivalent.
      ...
      iex> Otel.SemanticConventions.Attributes.Network.network_protocol_name()
  ...
  The actual version of the protocol used for network communication.
      ...
      iex> Otel.SemanticConventions.Attributes.Network.network_protocol_version()
  ...
  [OSI transport layer](https://wikipedia.org/wiki/Transport_layer) or [inter-process communication method](https://wikipedia.org/wiki/Inter-process_communication).
      ...
      iex> Otel.SemanticConventions.Attributes.Network.network_transport()
      "network.transport"
  """
  ...
  Enum values for `network_transport`.
      ...
      iex> Otel.SemanticConventions.Attributes.Network.network_transport_values()[:tcp]
      "tcp"
  """
  ...
  [OSI network layer](https://wikipedia.org/wiki/Network_layer) or non-OSI equivalent.
      ...
      iex> Otel.SemanticConventions.Attributes.Network.network_type()
      "network.type"
  """
  ...
  Enum values for `network_type`.
      ...
      iex> Otel.SemanticConventions.Attributes.Network.network_type_values()[:ipv4]
      "ipv4"
  """
