defmodule Otel.SemanticConventions.Attributes.JVM do
  ...
  Name of the garbage collector action.
      ...
      iex> Otel.SemanticConventions.Attributes.JVM.jvm_gc_action()
      "jvm.gc.action"
  """
  ...
  Name of the garbage collector.
      ...
      iex> Otel.SemanticConventions.Attributes.JVM.jvm_gc_name()
      "jvm.gc.name"
  """
  ...
  Name of the memory pool.
      ...
      iex> Otel.SemanticConventions.Attributes.JVM.jvm_memory_pool_name()
  ...
  The type of memory.
      ...
      iex> Otel.SemanticConventions.Attributes.JVM.jvm_memory_type()
      "jvm.memory.type"
  """
  ...
  Enum values for `jvm_memory_type`.
      ...
      iex> Otel.SemanticConventions.Attributes.JVM.jvm_memory_type_values()[:heap]
      "heap"
  """
  ...
  Whether the thread is daemon or not.
      ...
      iex> Otel.SemanticConventions.Attributes.JVM.jvm_thread_daemon()
      "jvm.thread.daemon"
  """
  ...
  State of the thread.
      ...
      iex> Otel.SemanticConventions.Attributes.JVM.jvm_thread_state()
      "jvm.thread.state"
  """
  ...
  Enum values for `jvm_thread_state`.
      ...
      iex> Otel.SemanticConventions.Attributes.JVM.jvm_thread_state_values()[:new]
      "new"
  """
