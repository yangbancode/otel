defmodule Otel.Trace.SpanExporter do
  ...
  @spec init(config :: term()) :: {:ok, Otel.Trace.SpanExporter.Behaviour.state()} | :ignore
  @impl true
  def init(config) do
  ...
  @spec export(
          ...
          state :: Otel.Trace.SpanExporter.Behaviour.state()
        ) :: :ok | :error
  @impl true
  ...
  @spec shutdown(state :: Otel.Trace.SpanExporter.Behaviour.state()) :: :ok
  @impl true
  def shutdown(_state), do: :ok

  @spec force_flush(state :: Otel.Trace.SpanExporter.Behaviour.state()) :: :ok
  @impl true
