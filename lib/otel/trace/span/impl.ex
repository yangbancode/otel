defmodule Otel.Trace.Span.Impl do
  @moduledoc """
  ...
  - `Otel.Trace.Span.Impl.dropped_attributes_count` (proto
    `Span` field 10)
  - `Otel.Trace.Span.Impl.dropped_events_count` (proto `Span`
    field 12)
  - `Otel.Trace.Span.Impl.dropped_links_count` (proto `Span`
    field 14)
  - `Otel.Trace.Event.Impl.dropped_attributes_count` (proto
    `Span.Event` field 4)
  - `Otel.Trace.Link.Impl.dropped_attributes_count` (proto
    `Span.Link` field 5)

  `Otel.Trace.Event.Impl` and `Otel.Trace.Link.Impl` are SDK
  ...
  @type t :: %__MODULE__{
          ...
          events: [Otel.Trace.Event.Impl.t()],
          dropped_events_count: non_neg_integer(),
          links: [Otel.Trace.Link.Impl.t()],
  ...
  defp warn_span_limits_applied(span) do
    ...
    if parts != [] do
      Logger.warning(
        "Otel.Trace.Span.Impl: span limits applied — dropped #{Enum.join(parts, ", ")}"
      )
    end
