defmodule Otel.Trace.Span do
  ...
  `Otel.Trace.set_current_span/1,2`, `make_current/1`, or
  ...
  `get_module/0` defaults to `Otel.Trace.Span.Noop` when no
  ...
  @typedoc """
  Options accepted by `Otel.Trace.Tracer.Behaviour` callback
  `start_span/4` and by facade `Otel.Trace.start_span/3,4`.
  ...
  **Application** (OTel API MUST) — "IsRecording" (`trace/api.md`
  ...
  `Otel.Trace.Span.Noop`.
  """
  @spec recording?(span_ctx :: Otel.Trace.SpanContext.t()) :: boolean()
  def recording?(%Otel.Trace.SpanContext{} = span_ctx) do
  ...
  **Application** (OTel API MUST) — "SetAttribute"
  ...
  def set_attribute(%Otel.Trace.SpanContext{} = span_ctx, key, value) do
  ...
  **Application** (OTel API MAY) — "SetAttributes" convenience
  ...
  @spec set_attributes(
          ...
          :ok
  def set_attributes(%Otel.Trace.SpanContext{} = span_ctx, attributes) do
  ...
  **Application** (OTel API MUST) — "AddEvent" (`trace/api.md`
  ...
  `Event` via `Otel.Trace.Event.new/3` — per spec L543-L544
  ...
  def add_event(%Otel.Trace.SpanContext{} = span_ctx, %Otel.Trace.Event{} = event) do
  ...
  **Application** (OTel API MUST) — "Add Link" (`trace/api.md`
  ...
  def add_link(%Otel.Trace.SpanContext{} = span_ctx, %Otel.Trace.Link{} = link) do
  ...
  **Application** (OTel API MUST) — "SetStatus" (`trace/api.md`
  ...
  `Status` via `Otel.Trace.Status.new/2` are protected from
  ...
  def set_status(%Otel.Trace.SpanContext{} = span_ctx, %Otel.Trace.Status{} = status) do
  ...
  **Application** (OTel API MUST) — "UpdateName" (`trace/api.md`
  ...
  def update_name(%Otel.Trace.SpanContext{} = span_ctx, name) do
  ...
  **Application** (OTel API MUST) — "End" (`trace/api.md`
  ...
  def end_span(
        %Otel.Trace.SpanContext{} = span_ctx,
  ...
  **SDK** (OTel API MUST) — "IsRecording" (`trace/api.md`
  ...
  non-recording.
  """
  @callback recording?(span_ctx :: Otel.Trace.SpanContext.t()) :: boolean()
  ...
  **SDK** (installation hook) — register the SDK Span operations
  ...
  `module` must implement the `Otel.Trace.Span` behaviour.
  """
  ...
  # operations module, defaulting to `Otel.Trace.Span.Noop`
