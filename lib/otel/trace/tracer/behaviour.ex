defmodule Otel.Trace.Tracer.Behaviour do
  @moduledoc """
  ...
  **Stable**, L184-L219).
  ...
  implements `Otel.Trace.Tracer.Behaviour` and `config` carries
  ...
  `Otel.Trace.Tracer.BehaviourProvider` rather than constructing the
  tuple directly.
  """
  @type t :: {module(), term()}
  ...
  define common parameters for `Enabled`. Since `Otel.Trace`
  ...
  **SDK** (OTel API MUST) — "Create a new Span" (`trace/api.md`
  ...
  Options are documented by `Otel.Trace.Span.start_opts/0`.
  """
  @callback start_span(
              ctx :: Otel.Ctx.t(),
              tracer :: t(),
