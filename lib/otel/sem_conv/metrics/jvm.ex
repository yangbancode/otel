defmodule Otel.SemConv.Metrics.JVM do
  ...
  Unit: `{class}`
      ...
      iex> Otel.SemConv.Metrics.JVM.jvm_class_count()
      "jvm.class.count"
  """
  ...
  Unit: `{class}`
      ...
      iex> Otel.SemConv.Metrics.JVM.jvm_class_loaded()
      "jvm.class.loaded"
  """
  ...
  Unit: `{class}`
      ...
      iex> Otel.SemConv.Metrics.JVM.jvm_class_unloaded()
      "jvm.class.unloaded"
  """
  ...
  Unit: `{cpu}`
      ...
      iex> Otel.SemConv.Metrics.JVM.jvm_cpu_count()
      "jvm.cpu.count"
  """
  ...
  Unit: `1`
      ...
      iex> Otel.SemConv.Metrics.JVM.jvm_cpu_recent_utilization()
  ...
  Unit: `s`
      ...
      iex> Otel.SemConv.Metrics.JVM.jvm_cpu_time()
      "jvm.cpu.time"
  """
  ...
  Unit: `s`
      ...
      iex> Otel.SemConv.Metrics.JVM.jvm_gc_duration()
      "jvm.gc.duration"
  """
  ...
  Unit: `By`
      ...
      iex> Otel.SemConv.Metrics.JVM.jvm_memory_committed()
  ...
  Unit: `By`
      ...
      iex> Otel.SemConv.Metrics.JVM.jvm_memory_limit()
      "jvm.memory.limit"
  """
  ...
  Unit: `By`
      ...
      iex> Otel.SemConv.Metrics.JVM.jvm_memory_used()
      "jvm.memory.used"
  """
  ...
  Unit: `By`
      ...
      iex> Otel.SemConv.Metrics.JVM.jvm_memory_used_after_last_gc()
  ...
  Unit: `{thread}`
      ...
      iex> Otel.SemConv.Metrics.JVM.jvm_thread_count()
      "jvm.thread.count"
  """
