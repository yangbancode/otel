defmodule Otel.SemConv.Metrics.Kestrel do
  ...
  Unit: `{connection}`
      ...
      iex> Otel.SemConv.Metrics.Kestrel.kestrel_active_connections()
  ...
  Unit: `{handshake}`
      ...
      iex> Otel.SemConv.Metrics.Kestrel.kestrel_active_tls_handshakes()
  ...
  Unit: `s`
      ...
      iex> Otel.SemConv.Metrics.Kestrel.kestrel_connection_duration()
  ...
  Unit: `{connection}`
      ...
      iex> Otel.SemConv.Metrics.Kestrel.kestrel_queued_connections()
  ...
  Unit: `{request}`
      ...
      iex> Otel.SemConv.Metrics.Kestrel.kestrel_queued_requests()
  ...
  Unit: `{connection}`
      ...
      iex> Otel.SemConv.Metrics.Kestrel.kestrel_rejected_connections()
  ...
  Unit: `s`
      ...
      iex> Otel.SemConv.Metrics.Kestrel.kestrel_tls_handshake_duration()
  ...
  Unit: `{connection}`
      ...
      iex> Otel.SemConv.Metrics.Kestrel.kestrel_upgraded_connections()
