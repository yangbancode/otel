defmodule Otel.SDK.Config.Selector do
  ...
  - **module atom** (e.g. `Otel.OTLP.Trace.Exporter.HTTP`) — direct
  ...
  @spec trace_exporter(value :: atom() | module() | {module(), map()}) ::
          {module(), map()} | :none
  def trace_exporter(:otlp), do: {Otel.OTLP.Trace.Exporter.HTTP, %{}}
  ...
  @spec metrics_exporter(value :: atom() | module() | {module(), map()}) ::
          {module(), map()} | :none
  def metrics_exporter(:otlp), do: {Otel.OTLP.Metrics.Exporter.HTTP, %{}}
  ...
  @spec logs_exporter(value :: atom() | module() | {module(), map()}) ::
          {module(), map()} | :none
  def logs_exporter(:otlp), do: {Otel.OTLP.Logs.Exporter.HTTP, %{}}
