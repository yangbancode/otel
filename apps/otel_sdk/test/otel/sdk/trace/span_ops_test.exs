defmodule Otel.SDK.Trace.SpanOpsTest.TestProcessor do
...
defmodule Otel.SDK.Trace.SpanOpsTest do
  use ExUnit.Case
  ...
  describe "recording?/1" do
    test "returns true for active span" do
      span_ctx = start_span()
      assert Otel.SDK.Trace.SpanOps.recording?(span_ctx) == true
    end

    test "returns false after end_span" do
      span_ctx = start_span()
      Otel.SDK.Trace.SpanOps.end_span(span_ctx, nil)
      assert Otel.SDK.Trace.SpanOps.recording?(span_ctx) == false
    end
  ...
  describe "set_attribute/3" do
    test "sets a single attribute" do
      span_ctx = start_span()
      Otel.SDK.Trace.SpanOps.set_attribute(span_ctx, :key, "value")
    ...
    test "overwrites existing attribute" do
      ...
      Otel.SDK.Trace.SpanOps.set_attribute(span_ctx, :key, "new")
    ...
    test "no-op on ended span" do
      span_ctx = start_span()
      Otel.SDK.Trace.SpanOps.end_span(span_ctx, nil)
      assert Otel.SDK.Trace.SpanOps.set_attribute(span_ctx, :key, "value") == :ok
    end

    test "enforces attribute_count_limit" do
      span_ctx = start_span(span_limits: %Otel.SDK.Trace.SpanLimits{attribute_count_limit: 2})
      Otel.SDK.Trace.SpanOps.set_attribute(span_ctx, :a, 1)
      Otel.SDK.Trace.SpanOps.set_attribute(span_ctx, :b, 2)
      Otel.SDK.Trace.SpanOps.set_attribute(span_ctx, :c, 3)
    ...
    test "allows overwrite even when at limit" do
      ...
      Otel.SDK.Trace.SpanOps.set_attribute(span_ctx, :a, 1)
      Otel.SDK.Trace.SpanOps.set_attribute(span_ctx, :a, 2)
    ...
    test "truncates string value" do
      ...
      Otel.SDK.Trace.SpanOps.set_attribute(span_ctx, :key, "hello world")
    ...
    test "does not truncate non-string values" do
      ...
      Otel.SDK.Trace.SpanOps.set_attribute(span_ctx, :num, 12_345)
    ...
    test "truncates strings inside arrays" do
      ...
      Otel.SDK.Trace.SpanOps.set_attribute(span_ctx, :tags, ["hello", "world"])
    ...
    test "infinity value length limit does not truncate" do
      ...
      Otel.SDK.Trace.SpanOps.set_attribute(span_ctx, :key, long_value)
  ...
  describe "set_attributes/2" do
    test "sets multiple attributes" do
      span_ctx = start_span()
      Otel.SDK.Trace.SpanOps.set_attributes(span_ctx, %{a: 1, b: 2})
    ...
    test "no-op on ended span" do
      span_ctx = start_span()
      Otel.SDK.Trace.SpanOps.end_span(span_ctx, nil)
      assert Otel.SDK.Trace.SpanOps.set_attributes(span_ctx, %{a: 1}) == :ok
    end

    test "overwrites existing keys" do
      span_ctx = start_span(attributes: %{key: "old"})
      Otel.SDK.Trace.SpanOps.set_attributes(span_ctx, %{key: "new"})
    ...
    test "enforces attribute_count_limit" do
      span_ctx = start_span(span_limits: %Otel.SDK.Trace.SpanLimits{attribute_count_limit: 2})
      Otel.SDK.Trace.SpanOps.set_attributes(span_ctx, %{a: 1, b: 2, c: 3})
  ...
  describe "add_event/3" do
    test "adds an event" do
      span_ctx = start_span()
      Otel.SDK.Trace.SpanOps.add_event(span_ctx, "my_event", [])
    ...
    test "adds event with attributes and custom time" do
      ...
      Otel.SDK.Trace.SpanOps.add_event(span_ctx, "event", time: ts, attributes: %{key: "val"})
    ...
    test "preserves insertion order" do
      span_ctx = start_span()
      Otel.SDK.Trace.SpanOps.add_event(span_ctx, "first", [])
      Otel.SDK.Trace.SpanOps.add_event(span_ctx, "second", [])
    ...
    test "truncates event attribute values" do
      ...
      Otel.SDK.Trace.SpanOps.add_event(span_ctx, "event", attributes: %{key: "hello world"})
    ...
    test "enforces attribute_per_event_limit" do
      ...
      Otel.SDK.Trace.SpanOps.add_event(span_ctx, "event", attributes: %{a: 1, b: 2, c: 3})
    ...
    test "no-op on ended span" do
      span_ctx = start_span()
      Otel.SDK.Trace.SpanOps.end_span(span_ctx, nil)
      Otel.SDK.Trace.SpanOps.add_event(span_ctx, "event", [])
  ...
  describe "add_link/3" do
    test "adds a link after creation" do
      ...
      Otel.SDK.Trace.SpanOps.add_link(span_ctx, linked, %{key: "val"})
    ...
    test "enforces link_count_limit" do
      ...
      Otel.SDK.Trace.SpanOps.add_link(span_ctx, Otel.API.Trace.SpanContext.new(1, 1), %{})
      Otel.SDK.Trace.SpanOps.add_link(span_ctx, Otel.API.Trace.SpanContext.new(2, 2), %{})
    ...
    test "no-op on ended span" do
      ...
      assert Otel.SDK.Trace.SpanOps.add_link(span_ctx, Otel.API.Trace.SpanContext.new(1, 1), %{}) ==
               :ok
    end
    ...
    test "truncates link attribute values" do
      ...
      Otel.SDK.Trace.SpanOps.add_link(
        span_ctx,
  ...
  describe "set_status/3" do
    test "sets error status with description" do
      span_ctx = start_span()
      Otel.SDK.Trace.SpanOps.set_status(span_ctx, :error, "something failed")
    ...
    test "sets ok status" do
      span_ctx = start_span()
      Otel.SDK.Trace.SpanOps.set_status(span_ctx, :ok, "")
    ...
    test "no-op on ended span" do
      span_ctx = start_span()
      Otel.SDK.Trace.SpanOps.end_span(span_ctx, nil)
      assert Otel.SDK.Trace.SpanOps.set_status(span_ctx, :error, "fail") == :ok
    end

    test "setting unset is ignored" do
      span_ctx = start_span()
      Otel.SDK.Trace.SpanOps.set_status(span_ctx, :error, "fail")
      Otel.SDK.Trace.SpanOps.set_status(span_ctx, :unset, "")
  ...
  describe "update_name/2" do
    test "updates the span name" do
      span_ctx = start_span()
      Otel.SDK.Trace.SpanOps.update_name(span_ctx, "new_name")
    ...
    test "no-op on ended span" do
      span_ctx = start_span()
      Otel.SDK.Trace.SpanOps.end_span(span_ctx, nil)
      assert Otel.SDK.Trace.SpanOps.update_name(span_ctx, "new_name") == :ok
    end
  end
  ...
  describe "end_span/2" do
    ...
    test "sets end_time" do
      span_ctx =
        start_span(
          processors: [
            {Otel.SDK.Trace.SpanOpsTest.TestProcessor, %{test_pid: self()}}
          ]
        )
    ...
    test "uses custom timestamp" do
      ...
      Otel.SDK.Trace.SpanOps.end_span(span_ctx, 42)
    ...
    test "second end_span is no-op" do
      span_ctx = start_span()
      assert Otel.SDK.Trace.SpanOps.end_span(span_ctx, nil) == :ok
      assert Otel.SDK.Trace.SpanOps.end_span(span_ctx, nil) == :ok
    end
  end
  ...
  describe "record_exception/4" do
    test "adds exception event" do
      ...
      Otel.SDK.Trace.SpanOps.record_exception(
        span_ctx,
