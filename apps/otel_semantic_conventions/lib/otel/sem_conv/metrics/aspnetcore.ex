defmodule Otel.SemConv.Metrics.AspNetCore do
  ...
  Unit: `{exception}`
      ...
      iex> Otel.SemConv.Metrics.AspNetCore.aspnetcore_diagnostics_exceptions()
  ...
  Unit: `{request}`
      ...
      iex> Otel.SemConv.Metrics.AspNetCore.aspnetcore_rate_limiting_active_request_leases()
  ...
  Unit: `{request}`
      ...
      iex> Otel.SemConv.Metrics.AspNetCore.aspnetcore_rate_limiting_queued_requests()
  ...
  Unit: `s`
      ...
      iex> Otel.SemConv.Metrics.AspNetCore.aspnetcore_rate_limiting_request_time_in_queue()
  ...
  Unit: `s`
      ...
      iex> Otel.SemConv.Metrics.AspNetCore.aspnetcore_rate_limiting_request_lease_duration()
  ...
  Unit: `{request}`
      ...
      iex> Otel.SemConv.Metrics.AspNetCore.aspnetcore_rate_limiting_requests()
  ...
  Unit: `{match_attempt}`
      ...
      iex> Otel.SemConv.Metrics.AspNetCore.aspnetcore_routing_match_attempts()
