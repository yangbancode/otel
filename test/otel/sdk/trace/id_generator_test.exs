defmodule Otel.SDK.Trace.IdGeneratorTest do
  use ExUnit.Case, async: true

  describe "generate_trace_id/0" do
    test "produces unique non-zero 128-bit integers" do
      ids = for _ <- 1..100, do: Otel.SDK.Trace.IdGenerator.generate_trace_id()
  ...
  describe "generate_span_id/0" do
    test "produces unique non-zero 64-bit integers" do
      ids = for _ <- 1..100, do: Otel.SDK.Trace.IdGenerator.generate_span_id()
